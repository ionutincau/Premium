...
public class JobHistory {
    ...
    public JobHistory(int id_job,Calendar start_date,Calendar end_date,int id_employee,int id_department,String status){
        this.id_job=id_job;
    ...
    public int getId_employee(){return this.id_employee;}
    ...
    public void setId_employee(int id_department){
        this.id_department=id_department;
    }
